...
export const visaSections: VisaSection[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "address_street", label: "Street No and Street Address", placeholder: "e.g. 184 Ilchester Road", type: "text" },
      ...
      { id: "address_phone", label: "Mobile/Landline Number and WhatsApp", placeholder: "e.g. 7507677927", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "emp_street", label: "Street No and Street Address (Employer/School)", placeholder: "", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "history_sticker_number", label: "Visa Sticker Number and Dates", placeholder: "", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "acc_street", label: "Street No and Street Address (Accommodation)", placeholder: "", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "finance_sponsor_name", label: "Sponsor Name and Surname", placeholder: "", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "family_first_name", label: "First and Middle Name", placeholder: "", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "minor_street", label: "Street No and Street Address", placeholder: "", type: "text" },
      ...
      { id: "minor_phone", label: "Mobile/Landline Number and WhatsApp", placeholder: "", type: "text" },
