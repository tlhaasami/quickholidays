            ...
            <div className="mt-16 max-w-4xl">
              <div className="rounded-[40px] border border-brand-gold/20 bg-brand-cream/95 p-8 shadow-[0_25px_80px_rgba(15,33,72,0.06)] backdrop-blur-sm">
                <form className="space-y-6">
                  ...
                  <div className="pt-2">
                    <button type="submit" className="inline-flex items-center justify-center rounded-full bg-brand-gold px-8 py-3 text-sm font-bold text-white shadow-md hover:bg-brand-gold-dark transition-all duration-200">
                      Book Consultation
                    </button>
                  </div>
                </form>
