  ...
  return (
    <div className="bg-white dark:bg-black min-h-screen text-zinc-950 dark:text-white pt-32 pb-24 px-8 sm:px-16 md:px-24 transition-colors duration-300">
      <div className="max-w-3xl mx-auto text-left space-y-8">
        ...
        <p className="font-sans text-sm sm:text-base text-zinc-600 dark:text-zinc-400 font-light leading-relaxed">
        ...
        {/* Content */}
        <div className="space-y-6 font-sans text-sm sm:text-base text-zinc-600 dark:text-zinc-300 font-light leading-relaxed">
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">1. What we collect and why</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">2. Legal basis (UK GDPR)</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">3. Storage and security</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">4. Data retention</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">5. Sharing third-parties</h3>
            <p>
        ...
        <div className="border-t border-zinc-200 dark:border-white/10 pt-8 mt-12 flex justify-between items-center text-xs font-sans">
          ...
          <Link href="/refund-policy" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white underline transition-colors">
            Refund Policy
          </Link>
        </div>
      </div>
