    ...
    <div className="relative min-h-screen flex flex-col bg-white font-sans select-none overflow-hidden">
      ...
      <div className="relative grow grid grid-cols-1 md:grid-cols-2 p-6 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center w-full">
          {/* Main glassmorphic card with entrance animation - higher opacity for readability */}
          <div className={`w-full max-w-lg bg-[#0F2148]/80 border border-white/10 rounded-[32px] p-8 shadow-2xl backdrop-blur-md text-left flex flex-col justify-center dark-autofill transition-all duration-[1000ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
