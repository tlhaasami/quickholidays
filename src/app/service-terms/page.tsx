  ...
  return (
    <div className="bg-white dark:bg-black min-h-screen text-zinc-950 dark:text-white pt-32 pb-24 px-8 sm:px-16 md:px-24 transition-colors duration-300">
      <div className="max-w-3xl mx-auto text-left space-y-8">
        ...
        <p className="font-sans text-sm sm:text-base text-zinc-500 dark:text-zinc-400 font-light leading-relaxed">
        ...
        <div className="space-y-6 font-sans text-sm sm:text-base text-zinc-600 dark:text-zinc-300 font-light leading-relaxed">
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">1. Scope of Service</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">2. Service Fees</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">3. Client Responsibilities</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">4. Processing Timelines</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">5. Refusals & Liability</h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif text-xl sm:text-2xl text-zinc-900 dark:text-white font-semibold">7. Regulatory Disclosure</h3>
            <p>
