  ...
  return (
    <div className="bg-white dark:bg-black min-h-screen text-zinc-950 dark:text-white pt-32 pb-24 px-8 sm:px-16 md:px-24 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto text-left">
        ...
        {/* Costs Table */}
        <div className="mb-16">
          <h2 className="font-serif text-2xl sm:text-3xl font-semibold mb-6 text-zinc-900 dark:text-white">Costs Breakdown</h2>
          <div className="overflow-x-auto rounded-xl border border-zinc-200 dark:border-white/10">
            <table className="w-full text-left border-collapse font-sans text-sm">
              <thead>
                <tr className="bg-zinc-100 dark:bg-zinc-950 border-b border-zinc-200 dark:border-white/10 text-zinc-600 dark:text-zinc-400 font-bold uppercase text-[10px] tracking-wider">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-white/5 text-zinc-700 dark:text-zinc-300">
                <tr>
                  <td className="px-6 py-4 font-semibold text-zinc-900 dark:text-white">Embassy Fee (Adult)</td>
