        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12 sm:mb-16">
          ...
          <div className="max-w-xl text-left">
            ...
            <div className="mt-4">
              <Link
                href="/schengen-visa"
                className="inline-flex items-center gap-2 rounded-full bg-brand-navy px-8 py-3.5 text-sm font-bold text-white shadow-md hover:bg-brand-gold hover:text-brand-navy hover:shadow-[0_0_20px_rgba(204,163,82,0.45)] hover:scale-[1.04] transition-all duration-300 group"
              >
                ...
                <svg
                  ...
                  strokeWidth={2.5}
                  stroke="currentColor"
                  className="w-4 h-4 text-brand-gold transition-colors group-hover:text-brand-navy transition-transform group-hover:translate-x-1"
                >
