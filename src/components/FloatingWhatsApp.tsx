...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className="fixed bottom-6 left-6 z-50 flex items-center justify-center p-3.5 bg-emerald-600 text-white rounded-full shadow-2xl hover:bg-emerald-500 hover:scale-105 active:scale-95 transition-all duration-300 group border border-emerald-500/30 md:hidden pointer-events-auto"
