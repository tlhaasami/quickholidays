  ...
  return (
    <footer className="relative bg-brand-dark text-slate-300 overflow-hidden pt-16 pb-8 border-t border-white/5">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-start gap-12 pb-12 border-b border-slate-800">
          ...
          <div className="text-left space-y-6 shrink-0">
          ...
          {/* Column 4: Contact Us */}
          <div className="max-w-[280px] text-left space-y-6 shrink-0">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                <div className="shrink-0 mt-0.5 text-brand-gold">
                  {/* Map Pin SVG */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
